...
@main_bp.route('/setup')
def setup():
    """Setup page for adding teams and players"""
...
def squads():
    ...
    teams = Team.query.all()
    return render_template('squads.html', teams=teams)
...
def auction_room():
    ...
    return render_template('auction.html', teams=teams, players=players, unsold_players=unsold_players, auction_state=auction_state)
